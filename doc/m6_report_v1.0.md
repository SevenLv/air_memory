...
本次系统确认覆盖 SRD v1.0 全部 28 条需求，包括：
...
| --- | --- | --- | --- |
| M6-AC-01 | SRD v1.0 全部 28 条需求均经过验证，无"未验证"状态 | 通过 | 28 条需求全部经过代码审查或文档审查，无"未验证"条目 |
...
> 注：PR-001 至 PR-011 共 11 条，加上 FR 类共 19 条，合计 30 行。其中"有条件通过"均因代码审查模式无法实际运行测量，或因已识别的 DEF-001/DEF-002 缺陷影响而标注。
